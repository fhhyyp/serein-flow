...
| `src/SereinFlow.SDK` | Typed HTTP client SDK for third-party applications. |
...
- [.NET client SDK](docs/en/client-sdk.md)
- [Worker protocol (v2 current, v1 historical compatibility)](docs/en/worker-protocol.md)
