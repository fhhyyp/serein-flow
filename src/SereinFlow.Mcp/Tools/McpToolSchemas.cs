        ...
        => ArraySchema(
            new
            {
                oneOf = new object[]
                {
                    ...
                    CanonicalPatchOperationSchema("addNodeParameter", "parameter", NodeParameterValueSchema(), ["canvasId", "nodeId", "parameter"], ("canvasId", StringSchema()), ("nodeId", StringSchema())),
                    CanonicalPatchOperationSchema("removeNodeParameter", null, null, ["canvasId", "nodeId", "parameterId"], ("canvasId", StringSchema()), ("nodeId", StringSchema()), ("parameterId", StringSchema())),
                    ...
                    LegacyPatchOperationSchema("addNodeParameter", NodeParameterValueSchema(), ["canvasId", "nodeId", "value"], ("canvasId", StringSchema()), ("nodeId", StringSchema())),
                    LegacyPatchOperationSchema("removeNodeParameter", null, ["canvasId", "nodeId", "parameterId"], ("canvasId", StringSchema()), ("nodeId", StringSchema()), ("parameterId", StringSchema())),
